...
//go:generate go run github.com/rink-labs/libevm/cmd/abigen --pkg warpbindings --type IWarpMessenger --abi ../IWarpMessenger.abi --bin artifacts/IWarpMessenger.bin --out gen_iwarpmessenger_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/rink-labs/libevm/accounts/abi|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi|g' -e 's|github.com/rink-labs/libevm/accounts/abi/bind|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi/bind|g' gen_iwarpmessenger_binding.go && rm -f gen_iwarpmessenger_binding.go.bak"
