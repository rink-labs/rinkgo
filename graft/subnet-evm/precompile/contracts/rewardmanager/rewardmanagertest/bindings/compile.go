...
//go:generate go run github.com/rink-labs/libevm/cmd/abigen --pkg bindings --type IRewardManager --abi ../../IRewardManager.abi --bin artifacts/IRewardManager.bin --out gen_irewardmanager_binding.go
//go:generate go run github.com/rink-labs/libevm/cmd/abigen --pkg bindings --type RewardManagerTest --abi artifacts/RewardManagerTest.abi --bin artifacts/RewardManagerTest.bin --out gen_rewardmanagertest_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/rink-labs/libevm/accounts/abi|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi|g' -e 's|github.com/rink-labs/libevm/accounts/abi/bind|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi/bind|g' gen_irewardmanager_binding.go gen_rewardmanagertest_binding.go && rm -f gen_irewardmanager_binding.go.bak gen_rewardmanagertest_binding.go.bak"
