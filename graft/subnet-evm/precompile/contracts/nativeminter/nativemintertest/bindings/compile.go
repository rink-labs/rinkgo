...
//go:generate go run github.com/rink-labs/libevm/cmd/abigen --pkg bindings --type INativeMinter --abi ../../INativeMinter.abi --bin artifacts/INativeMinter.bin --out gen_inativeminter_binding.go
//go:generate go run github.com/rink-labs/libevm/cmd/abigen --pkg bindings --type NativeMinterTest --abi artifacts/NativeMinterTest.abi --bin artifacts/NativeMinterTest.bin --out gen_nativemintertest_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/rink-labs/libevm/accounts/abi|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi|g' -e 's|github.com/rink-labs/libevm/accounts/abi/bind|github.com/rink-labs/rinkgo/graft/subnet-evm/accounts/abi/bind|g' gen_inativeminter_binding.go gen_nativemintertest_binding.go && rm -f gen_inativeminter_binding.go.bak gen_nativemintertest_binding.go.bak"
