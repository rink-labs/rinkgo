...
> **Note**: These are the configuration options available in the Subnet-EVM codebase. To set these values, you need to create a configuration file at `~/.rinkgo/configs/chains/<blockchainID>/config.json`.
>
