...
```bash
cd $GOPATH/src/github.com/rink-labs/subnet-evm/cmd/simulator
```
...
To start a single node network, follow the instructions from the AvalancheGo [README](https://github.com/rink-labs/rinkgo#building-avalanchego) to build from source.
