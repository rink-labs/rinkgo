...
import (
	...
	"github.com/rink-labs/rinkgo/api/admin"
	...
	"github.com/rink-labs/rinkgo/nat"
	"github.com/rink-labs/rinkgo/network"
	"github.com/rink-labs/rinkgo/network/dialer"
	...
	"github.com/rink-labs/rinkgo/utils/crypto/bls/signer/rpcsigner"
	"github.com/rink-labs/rinkgo/utils/dynamicip"
	...
	"github.com/rink-labs/rinkgo/vms/registry"
	"github.com/rink-labs/rinkgo/vms/rpcchainvm/runtime"

	databasefactory "github.com/rink-labs/rinkgo/database/factory"
	coreth "github.com/rink-labs/rinkgo/graft/coreth/plugin/factory"
	avmconfig "github.com/rink-labs/rinkgo/vms/avm/config"
	platformconfig "github.com/rink-labs/rinkgo/vms/platformvm/config"
)
	...
	futureUpgradeCheck := health.CheckerFunc(func(context.Context) (interface{}, error) {
		...
		if time.Since(lastLogTime) >= logFrequency {
			log("unknown upgrade detected - this node should be updated to a compatible version",
				zap.String("latestReleaseURL", "https://github.com/rink-labs/rinkgo/releases/latest"),
